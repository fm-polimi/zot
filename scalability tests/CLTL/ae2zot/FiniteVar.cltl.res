...
Evaluation took:
  2.510 seconds of real time
  0.004000 seconds of total run time (0.000000 user, 0.004000 system)
  0.16% CPU
  8,534,062,859 processor cycles
  0 bytes consed
  
---UNSAT---
Evaluation took:
  2.844 seconds of real time
  0.336000 seconds of total run time (0.324000 user, 0.012000 system)
  [ Run times consist of 0.020 seconds GC time, and 0.316 seconds non-GC time. ]
  11.81% CPU
  9,670,553,475 processor cycles
  70,076,928 bytes consed
