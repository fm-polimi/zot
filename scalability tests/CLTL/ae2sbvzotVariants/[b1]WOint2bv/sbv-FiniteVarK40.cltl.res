...
Evaluation took:
  3.823 seconds of real time
  0.000000 seconds of total run time (0.000000 user, 0.000000 system)
  0.00% CPU
  12,999,704,764 processor cycles
  0 bytes consed
  
---SAT---
The plugin is used for completeness check, and by default no model is returned. Enable the flag getLFmodel in order to include the model.
Evaluation took:
  3.868 seconds of real time
  0.044000 seconds of total run time (0.040000 user, 0.004000 system)
  1.14% CPU
  13,151,958,314 processor cycles
  6,650,064 bytes consed
