...
Evaluation took:
  ...
  0.00% CPU
  4,993,427,381 processor cycles
  32,624 bytes consed
  
---UNSAT---
Evaluation took:
  1.508 seconds of real time
  0.040000 seconds of total run time (0.036000 user, 0.004000 system)
  [ Run times consist of 0.012 seconds GC time, and 0.028 seconds non-GC time. ]
  2.65% CPU
  5,127,347,412 processor cycles
  5,399,808 bytes consed
