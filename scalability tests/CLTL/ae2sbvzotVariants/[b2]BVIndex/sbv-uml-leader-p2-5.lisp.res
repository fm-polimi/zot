...
Evaluation took:
  ...
  0.00% CPU
  12,998,005,886 processor cycles
  0 bytes consed
  
---UNSAT---
Evaluation took:
  4.068 seconds of real time
  0.244000 seconds of total run time (0.236000 user, 0.008000 system)
  [ Run times consist of 0.020 seconds GC time, and 0.224 seconds non-GC time. ]
  6.00% CPU
  13,831,041,412 processor cycles
  59,140,336 bytes consed
