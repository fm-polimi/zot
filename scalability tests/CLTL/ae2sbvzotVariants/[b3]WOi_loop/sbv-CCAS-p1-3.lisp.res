...
Evaluation took:
  ...
  0.00% CPU
  67,749,374,649 processor cycles
  0 bytes consed
  
---SAT---
------ time 0 ------
Evaluation took:
  20.686 seconds of real time
  0.756000 seconds of total run time (0.684000 user, 0.072000 system)
  [ Run times consist of 0.088 seconds GC time, and 0.668 seconds non-GC time. ]
  3.65% CPU
  70,330,550,052 processor cycles
  2,687,208,464 bytes consed
