...
Evaluation took:
  ...
  0.00% CPU
  9,463,965,376 processor cycles
  0 bytes consed
  
---SAT---
------ time 0 ------
Evaluation took:
  2.978 seconds of real time
  0.196000 seconds of total run time (0.180000 user, 0.016000 system)
  [ Run times consist of 0.048 seconds GC time, and 0.148 seconds non-GC time. ]
  6.58% CPU
  10,125,249,181 processor cycles
  554,936,736 bytes consed
