...
; compiling file "/home/fmbiased/zot/trunk/asdfs/ae2sbvzot.lisp" (written 25 FEB 2017 06:51:40 PM):
...
Evaluation took:
  ...
  0.00% CPU
  35,729,427,795 processor cycles
  0 bytes consed
  
---SAT---
------ time 0 ------
Evaluation took:
  11.282 seconds of real time
  0.736000 seconds of total run time (0.664000 user, 0.072000 system)
  [ Run times consist of 0.224 seconds GC time, and 0.512 seconds non-GC time. ]
  6.52% CPU
  38,356,800,133 processor cycles
  5 page faults
  2,284,116,352 bytes consed
