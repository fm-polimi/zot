...
(<-> (||  (past (-P- MADESYSTEMSTART) 1) (lasted (!! (-P- radarClockTICK)) 9)) (-P- radarClockTICK))
...
(<-> (&&  (-P- $OBJctrl_STDStateMachine1_STATEwarning) (&&  ([<] (-V- OBJctrlPARAMreceivedDistance) 2) (&&  (lasted_ii (!! (-P- OBJctrl_STDStateMachine1_STATEwarning_ENTER)) 40) (somp (-P- OBJctrl_STDStateMachine1_STATEwarning_ENTER))))) (-P- OBJctrl_STDStateMachine1_TRANSITION_qgxUMAODEeKTXbQztILh3g_GUARD))
...
;;; PROPERTIES
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defvar Q1 (alwf (-> (lasted ([<] (-V- SDsendSensorDistancePARdistance) 2) 64) (withinp (-P- $OBJbrakeS_STDStateMachine1_STATEbraking) 64))) )
