...
(defvar Drel (loop for i from 0 to Trel collect i) )  ;;Trel=4 NB altrove nel fole compare constante simbolica Trel 
(defvar Dreq (loop for i from 0 to Treq collect i) )  ;;Treq=3 NB altrove nel fole compare constante simbolica Treq
